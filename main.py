...
class Root(ctk.CTk):
    ...
    def __init__(self, init):
        ...
        text="Escolha um app ou adicione um novo.", width=500)
        ...
        clear_button = ctk.CTkButton(master=self, text="clear", width=70,
    ...
    def app_buttons(self, init):
        for item in range(0, init.list_number): # Loop around the list of app names and create apps with their names.
            ...
            button = ctk.CTkButton(master=self, width=70, text=init.names_list[item], compound="bottom",
